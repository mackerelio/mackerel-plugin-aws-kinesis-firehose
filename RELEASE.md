...
2. `git tag vx.y.z`
3. git push --tags
4. Wait to build at https://travis-ci.org/mackerelio/mackerel-plugin-aws-kinesis-firehose
5. See https://github.com/mackerelio/mackerel-plugin-aws-kinesis-firehose/releases
